...
9. Develop threejs game loop to live render multiple players. - **28/2/2026**
10. Compose or acquire player model. - **29/2/2026**
11. Develop basic player actions, move, jump, ect. - **1/3/2026**
12. Generate assets ad hoc to create first game. - **1/3/2026**
13. Script and program game loop so the game is playable. - **12/3/2026**
14. Implement API routes to generate game sessions. - **14/3/2026**
15. Develop frontend to create and join game sessions. - **14/3/2026**
16. Develop and integrate frontend to serve the game client embedded in the frontend. - **15/3/2026**
17. Integrate backend API to spawn game servers - **16/3/2026**
    - kubernetes(helm)
    - docker(dind)
18. Figure out production deployment and proxy. - **16/3/2026**
